...
class MedicalReportGenerator(nn.Module):
    def __init__(self, model_name: str, hidden_layer_size: int, classes: int, semantic_features_dim: int , att_units: int, 
        ...
        # Attention Module: Bahdanau Attention
            ...
            self.attention = BahdanauAttention(features_dim, hidden_dim, att_units, d_model)
        ...
        self.sent_lstm = SentLSTM( hidden_dim, lstm_layers, features_dim, hidden_layer_size, d_model, batch_first, enforce_info)
