...
def train(cfg: DictConfig):
    ...
    deepspeed_plugin = DeepSpeedPlugin(zero_stage=3, gradient_accumulation_steps=cfg.training.gradient_accumulation_steps, cpu_checkpointing=True, offload_param_device= 'cpu', 
